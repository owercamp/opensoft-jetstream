...
$classes = ($active ?? false)
            ...
            : 'block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-indigo-700 focus:outline-none focus:bg-gray-100 dark:focus:bg-indigo-700 transition duration-150 ease-in-out';
@endphp
